        ...
        <ul className="nav">
          ...
          {network !== "heco" && (
            <li>
              <NavLink
                className={`nowrap ${
                  location.pathname === "/projects" ? "bottom-curve" : ""
                }`}
          ...
          {network !== "heco" && (
            <li>
              <NavLink
                className={`nowrap ${
                  location.pathname === "/community-projects" ? "top-curve" : ""
          ...
          <li>
            <NavLink
              className={`nowrap ${
                location.pathname === "/farming-detail" ? "top-curve" : ""
              } ${
          ...
          <li>
            <NavLink
              className={`nowrap ${
                location.pathname === "/coming/dashboard" ? "top-curve" : ""
              }`}
              activeClassName="active"
              to="/blog"
            >
